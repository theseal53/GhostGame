...
public class TilePositionParser
{
	...
	{
		TilePosition[][] tiles = new TilePosition[columns][];
	...
	public TilePosition[][] Parse(int[][] tileTypes)
	{
		numRows = tileTypes.Length;
		numColumns = tileTypes[0].Length;
	...
	private TilePosition DetermineCellPosition(int row, int column, int[][] tileTypes)
	{
		int numRows = tileTypes.Length;
		int numColumns = tileTypes[0].Length;
	...
	private TilePosition DetermineWallTile(int row, int column, int[][] tileTypes)
	{
		int numRows = tileTypes.Length;
		int numColumns = tileTypes[0].Length;
		if (
